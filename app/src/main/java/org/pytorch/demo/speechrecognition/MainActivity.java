...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private final Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            MainActivity.this.runOnUiThread(
                    () -> {
                        mButton.setText(String.format(Locale.getDefault(), "Listening - %ds left", AUDIO_LEN_IN_SECOND - mStart));
                        mStart += 1;
                    });
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(v -> {
            mButton.setText(String.format(Locale.getDefault(), "Listening - %ds left", AUDIO_LEN_IN_SECOND));
    ...
    public void run() {
        ...
        runOnUiThread(() -> mButton.setText("Recognizing..."));
    ...
    private String recognize(float[] floatInputBuffer) {
        if (mModuleEncoder == null) {
            final String moduleFileAbsoluteFilePath = new File(
                    Objects.requireNonNull(assetFilePath(this, "model.pt"))).getAbsolutePath();
        ...
        final IValue[] result = mModuleEncoder.runMethod("predict", IValue.from(inTensor)).toList();
